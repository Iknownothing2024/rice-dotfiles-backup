...
const Blogs = () => {
  const blogPosts = [
    ...
    },
    {
      ...
      date: "2024-12-10",
      views: 987,
      excerpt: "Best practices for creating maintainable and scalable React applications with proper architecture.",
    ...
    },
    {
      ...
      date: "2024-12-05",
      views: 1432,
      excerpt: "A comprehensive guide to choosing between CSS Grid and Flexbox for different layout scenarios.",
