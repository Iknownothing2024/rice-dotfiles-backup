...
const Hero = () => {
  ...
  <div className="bg-black/80 backdrop-blur-sm rounded-lg p-3 border-2 border-green-400">
    <h2 className="text-2xl font-bold text-green-400 mb-1" style={{ fontFamily: 'monospace', textShadow: '2px 2px 0px rgba(0,0,0,0.5)' }}>返昔南柯</h2>
    <div className="text-green-300 text-sm" style={{ fontFamily: 'monospace', letterSpacing: '2px', textShadow: '1px 1px 0px rgba(0,0,0,0.5)' }}>手记</div>
  </div>
</div>
