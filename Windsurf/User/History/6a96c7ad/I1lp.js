...
export const useAudioPlayer = (tracks, initialIndex = 0, autoPlay = false) => {
  ...
  }, [currentTrack?.src]); // Use track source for dependency
  ...
  }, [currentTrack?.id, autoPlay, currentIndex]); // Use currentTrack.id instead of isPlaying
  ...
  }, [currentIndex, handleNext]); // Include handleNext dependency
  ...
  }, [currentTrack?.src, autoPlay, userPaused]); // Use track source for dependency
  ...
  }, [isPlaying, currentTrack?.src]); // Use track source to prevent stale closures
