  ...
  return (
    <div className="max-w-full mx-auto my-16 px-0">
      ...
      <style>{`
        ...
        /* Label spacing with increased horizontal gap */
        .wl-meta label {
          margin-right: 25px !important;
          color: #e5e7eb !important;
        }
        
        /* Header items with increased vertical spacing */
        .wl-header-item,
        .wl-header-items > div {
          margin-bottom: 20px !important;
        }
        
        /* Ensure proper alignment after spacing adjustments */
        .wl-header-items {
        ...
        /* Increased margin between nickname and timestamp */
        .wl-nick {
