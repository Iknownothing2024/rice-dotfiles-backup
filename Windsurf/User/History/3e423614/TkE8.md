...
### Layout & Width
- **Container**: `max-w-7xl mx-auto my-8 px-4` for wide layout matching BlogArticle
- **Responsive**: Mobile-friendly with proper padding adjustments
- **Spacing**: Consistent margins and padding with site design
...
- **Placeholder**: `#9ca3af` - Muted gray for placeholder text
...
#### Input Fields (`.wl-input`, `.wl-meta-input`)
```css
.wl-input,
.wl-meta-input {
  background: rgba(0, 0, 0, 0.2) !important;
