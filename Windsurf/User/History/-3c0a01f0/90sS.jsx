        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-800/40 backdrop-blur-sm rounded-lg p-6 border border-gray-700/30">
            ...
            <div className="space-y-4 text-gray-200/90">
              <p>
                网络漫游者，蛰居在阴暗小房间的宅男，妄想时空穿越，想转生異世界，永遠に十八歳未満です
              </p>
              <p>ER  每天重复死宅家里蹲幻想梦幻阴暗欢乐生活就像佐藤西条拓己人见 ER</p>
              <div className="text-xl font-bold text-white">Antinatalist</div>
              <div className="text-xl font-bold text-white"> I hate DQN and Social Media Cesspool</div>
              <div className="text-sm text-white">an adherent of the blackpill worldview</div>
            ...
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-lg p-6 border border-gray-700/30">
              ...
              <div className="space-y-2 text-sm text-gray-200/90">
                <div className="flex justify-between">
                  <span>所在国家</span>
                  <span className="text-gray-300/70">中華</span>
                </div>
                <div className="flex justify-between">
                  <span>所在区域</span>
