...
const imageModules = import.meta.glob('/Pics/RandomBackgroundPics/*.{jpeg,jpg,png,webp}', { 
  eager: true, 
  query: '?url', 
  import: 'default' 
});
...
// Temporary test to verify paths
console.log('Background images loaded:', backgroundImages);
console.log('Image modules raw:', imageModules);
