...
// Extract file paths from imported modules and ensure proper public URL format
export const backgroundImages = Object.values(imageModules).map(path => 
  path.replace('/public', '') // Remove /public prefix for proper browser resolution
);
