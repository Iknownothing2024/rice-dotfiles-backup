...
import billyCover from "./assets/Books/Covers/24BillyCover.jpg";
import "./App.css";
    ...
    <main className="container">
      ...
      {selectedBook === null ? (
        ...
        <section className="book-detail" aria-label="Book Detail">
          ...
          <div className="book-detail-layout flex flex-col items-center gap-4  sm:flex-row sm:items-start">
            <div className="w-48 max-w-full aspect-[2/3] overflow-hidden rounded-lg">
              <img
            ...
            <div className="book-detail-body text-left">
              ...
              <div className="book-detail-author">{selectedBook.author}</div>
