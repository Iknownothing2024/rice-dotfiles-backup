...
import flowers from "./assets/Books/献给阿尔吉侬的花束 (丹尼尔·凯斯).epub";
import billyCover from "./assets/Books/Covers/BiliCover.jpg";
import billy from "./assets/Books/24个比利+比利战争 (丹尼尔·凯斯).epub";
import juegeCover from "./assets/Books/Covers/Juege.png";
import juege from "./assets/Books/绝歌 日本神户地区连续儿童杀伤事件 (元少年A).epub";
...
function App() {
  ...
  return (
    <main className="container">
      <h1 className="text-8xl font-extrabold tracking-tighter sm:text-7xl">
      书库
    </h1>
