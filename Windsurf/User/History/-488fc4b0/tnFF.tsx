...
const MOCK_BOOKS: Book[] = [
  ...
  },
  {
    ...
    author: "元少年A（东慎太郎）",
    description: 
      "《絶歌》是一部由1997年震惊日本的“神户连续幼儿伤杀事件”（又称“酒鬼蔷薇圣斗事件”）的凶手少年A所著的自传，“绝歌”二字寓意“绝命之歌”。作者在序言中表示，这本书是他作为“少年A”的最后告白，通过这种方式将曾经那个扭曲的自我埋葬，从而以一个“人”的身份重新站立。",
    downloadUrl: juege,
  },
  {
    ...
    <main className="container">
      ...
      {selectedBook === null ? (
        ...
        <section className="book-detail" aria-label="Book Detail" >
          ...
          <div className="book-detail-layout flex flex-col items-center gap-8  ">
            ...
            <div className="book-detail-body text-left space-y-4">
              ...
              <p className="book-detail-description leading-relaxed">{selectedBook.description}</p>
              <a 
