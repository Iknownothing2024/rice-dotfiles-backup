...
const Sidebar = memo(() => {
  ...
  return (
    <aside className="fixed left-32 top-16 w-80 h-[calc(80vh-4rem)] bg-gray-800/30 backdrop-blur-md p-6 rounded-lg border border-gray-700/30 shadow-2xl overflow-y-auto">
      {/* Profile Section */}
      <div className="mb-8">
        <img
          src={MaxrenjianImage}
