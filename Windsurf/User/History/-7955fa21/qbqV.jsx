...
const Sidebar = memo(() => {
  ...
  return (
    <aside className="fixed left-32 top-16 w-80 h-[calc(100vh-4rem)] bg-gray-800/30 backdrop-blur-md p-6 rounded-lg border border-gray-700/30 shadow-2xl overflow-y-auto">
      {/* Profile Section */}
      <div className="mb-8">
        <img
          src={MaxrenjianImage}
        ...
        <div className="flex justify-around text-center mb-6">
          <div>
            ...
            <div className="text-xs text-gray-400/80">Posts</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-primary-400">0</div>
            <div className="text-xs text-gray-400/80">Tags</div>
          </div>
        </div>
      </div>
