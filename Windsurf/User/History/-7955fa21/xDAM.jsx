...
const Sidebar = memo(() => {
  ...
  return (
    <aside className="fixed left-24 top-32 w-80 h-[calc(64vh-4rem)] bg-gray-800/30 backdrop-blur-md p-6 rounded-lg border border-gray-700/30 shadow-2xl overflow-y-auto">
      {/* Profile Section */}
      <div className="mb-8">
        <img
          src={MaxrenjianImage}
          alt="Profile"
          className="w-24 h-24 rounded-full mx-auto mb-4 object-cover ring-2 ring-gray-600/50"
          loading="lazy"
        />
        <h2 className="text-xl font-bold text-center mb-2 text-white">人見広介</h2>
        <p className="text-gray-300/80 text-sm text-center mb-4">
          没有天赋，没有才能，什么都没有
          <br />
          只想重开到2019~2020
        </p>
        ...
        <div className="flex justify-around text-center mb-6">
          ...
          >
            ...
            <div className="text-xs text-gray-400/80 group-hover:text-gray-300">Posts</div>
          </Link>
          <Link 
            to="/tags"
            className="group cursor-pointer hover:scale-105 transition-all duration-300"
          ...
          >
            ...
            <div className="text-xs text-gray-400/80 group-hover:text-gray-300">Tags</div>
          </Link>
        </div>
      </div>
        ...
        <div className="flex gap-0 justify-center">
          {socialLinks.map((social, index) => (
            <a
              ...
              className="w-12 h-12 rounded flex items-center justify-center hover:bg-gray-700/50 transition-all duration-300 hover:scale-110"
