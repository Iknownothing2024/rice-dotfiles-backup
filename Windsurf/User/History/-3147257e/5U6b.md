...
### API Call Prevention
- **Issue**: Repeated "Update counter failed with 500: Not initialized" errors
- **Fix**: Disabled `pageview` counter by setting `pageview: false`
- **Result**: Eliminates unnecessary API calls and error messages
