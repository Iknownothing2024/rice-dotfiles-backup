...
import { Search, Rss, Github, Linkedin, Mail, Calendar, Eye, Tag, Archive, Radio } from 'lucide-react';
      ...
      <aside className="w-80 bg-gray-800 p-6 border-r border-gray-700">
        ...
        <div className="mb-8">
          <div className="w-24 h-24 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full mx-auto mb-4 flex items-center justify-center">
            <span className="text-3xl font-bold text-white">#_#</span>
          </div>
          <h2 className="text-xl font-bold text-center mb-2">返昔駅</h2>
          <p className="text-gray-400 text-sm text-center mb-4">
            Digital creator and developer. Sharing thoughts on technology, design, and life.
          </p>
