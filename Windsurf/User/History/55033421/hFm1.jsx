        ...
        <div className="mb-6">
          <div className="flex gap-3 justify-center">
            ...
            <a
              ...
              className="w-8 h-8 bg-gray-700 rounded flex items-center justify-center hover:bg-gray-600 transition-colors"
            >
              <img src="/bilibili-fill.svg" alt="Bilibili" className="w-4 h-4" />
            </a>
            <a
              ...
              className="w-8 h-8 bg-gray-700 rounded flex items-center justify-center hover:bg-gray-600 transition-colors"
            >
              <img src="/zhihu-line.svg" alt="Zhihu" className="w-4 h-4" />
            </a>
            <a
            ...
            <a
              ...
              className="w-8 h-8 bg-gray-700 rounded flex items-center justify-center hover:bg-gray-600 transition-colors"
            >
              <img src="/linuxDo.svg" alt="LinuxDo" className="w-4 h-4" />
            </a>
          </div>
        </aside>
