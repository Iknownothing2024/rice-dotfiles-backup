      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            ...
            <div className="p-4">
              <h3 className="text-lg font-semibold mb-2">Droomer</h3>
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            ...
            <div className="p-4">
              <h3 className="text-lg font-semibold mb-2">Summer Coast</h3>
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            ...
            <div className="p-4">
              <h3 className="text-lg font-semibold mb-2">异世界牌坊</h3>
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            ...
            <div className="p-4">
              <h3 className="text-lg font-semibold mb-2">Anime Countryside Scene</h3>
