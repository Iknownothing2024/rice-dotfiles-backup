        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-400 text-sm">Just a random pic I found in internet at the very old time</p>
            </div>
          </div>
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-400 text-sm">found on the internet from a very long time</p>
            </div>
          </div>
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            <img src="/gallery7.jpg" alt="Color Splash" className="w-full h-64 object-cover" />
            <div className="p-4">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            <img src="/gallery8.jpg" alt="Geometric Patterns" className="w-full h-64 object-cover" />
            <div className="p-4">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            <img src="/gallery9.jpg" alt="Digital Dreams" className="w-full h-64 object-cover" />
            <div className="p-4">
              <h3 className="text-lg font-semibold mb-2">Digital Dreams</h3>
              <p className="text-gray-400 text-sm">Surreal digital artwork</p>
            </div>
          </div>
        </div>
      </div>
