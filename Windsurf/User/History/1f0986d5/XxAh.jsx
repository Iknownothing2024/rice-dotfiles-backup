    ...
    <div className="min-h-screen bg-gray-900 text-white py-12">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            <img src="/src/assets/Pics/gallery8.png" alt="Geometric Patterns" className="w-full h-64 object-cover" />
            <div className="p-4">
          ...
          <div className="bg-gray-800 rounded-lg overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
            <img src="/src/assets/Pics/gallery9.jpg" alt="Digital Dreams" className="w-full h-64 object-cover" />
            <div className="p-4">
