...
const PostPage = memo(() => {
  ...
  console.log('PostPage Debug:', { slug, content, loading, error });
  ...
  console.log('PostPage: Content loaded, length:', content.length);
    ...
    <div className="min-h-screen bg-gray-900 text-white py-12">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mt-8 p-4 bg-gray-800 rounded-lg">
          <pre className="text-gray-300 text-sm">{content.substring(0, 200)}...</pre>
        </div>
      </div>
    </div>
  );
